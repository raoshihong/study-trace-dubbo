...
public class MybatisPlusGenerator {
	...
	public static void main(String[] args) {
		generator("t_event");
		generator("t_event_content");
		generator("t_event_place");
		generator("t_event_user");
	}
	...
	public static void generator(String tableName){
		...
		// 项目名称
		String projectName = "study-trace-dubbo";
		String jdbcDriver = "com.mysql.jdbc.Driver";
		String jdbcUrl = "jdbc:mysql://localhost:3306/tb_event";
		String jdbcUserName = "root";
		String jdbcPsw = "123456";

		String baseCodePackage = "com.rao.study.trace.dubbo";
